...
{
    [DbContext(typeof(FlowersB2cContext))]
    partial class FlowersB2cContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowers.Models.Categoria", b =>
                {
            ...
            modelBuilder.Entity("Flowers.Models.DetalleVenta", b =>
                {
            ...
            modelBuilder.Entity("Flowers.Models.Producto", b =>
                {
                    b.Property<int>("IdProducto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Flowers.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Flowers.Models.Venta", b =>
                {
                    b.Property<int>("IdVenta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Flowers.Models.DetalleVenta", b =>
                {
                    b.HasOne("Flowers.Models.Producto", "IdProductoNavigation")
                        .WithMany("DetalleVenta")
                        .HasForeignKey("IdProducto")
                        .HasConstraintName("FK__Detalle_V__id_pr__45F365D3");

                    b.HasOne("Flowers.Models.Venta", "IdVentaNavigation")
                        .WithMany("DetalleVenta")
            ...
            modelBuilder.Entity("Flowers.Models.Producto", b =>
                {
                    b.HasOne("Flowers.Models.Categoria", "IdCategoriaNavigation")
                        .WithMany("Productos")
            ...
            modelBuilder.Entity("Flowers.Models.Venta", b =>
                {
                    b.HasOne("Flowers.Models.Usuario", "IdUsuarioNavigation")
                        .WithMany("Venta")
